 ...
 **/
enum S3_MAX_HOSTNAME_SIZE =             255;

/**
 * This is the default hostname that is being used for the S3 requests
 **/
enum S3_DEFAULT_HOSTNAME =              "s3.amazonaws.com";
 ...
 **/
enum S3_MAX_METADATA_SIZE =             2048;


/**
 * S3_METADATA_HEADER_NAME_PREFIX is the prefix of an S3 "meta header"
 **/
enum S3_METADATA_HEADER_NAME_PREFIX =   "x-amz-meta-";
 ...
 * "x-amz-meta-nv".
 **/
enum S3_MAX_METADATA_COUNT =
    (S3_MAX_METADATA_SIZE / char.sizeof*((S3_METADATA_HEADER_NAME_PREFIX ~ "nv")).length - 1);
 ...
 **/
enum S3_MAX_ACL_GRANT_COUNT =           100;
 ...
 **/
enum S3_MAX_GRANTEE_EMAIL_ADDRESS_SIZE =128;
 ...
 **/
enum S3_MAX_GRANTEE_USER_ID_SIZE =      128;
 ...
 **/
enum S3_MAX_GRANTEE_DISPLAY_NAME_SIZE = 128;
 ...
 * query string
 **/
enum S3_MAX_AUTHENTICATED_QUERY_STRING_SIZE =
    ("https:///".length*char.sizeof + S3_MAX_HOSTNAME_SIZE + (S3_MAX_KEY_SIZE * 3) +
     "?AWSAccessKeyId=".length*char.sizeof + 32 + "&Expires=".length*char.sizeof + 32 +
     "&Signature=".length*char.sizeof + 28 + 1);
 ...
 **/
enum S3_INIT_ALL =                      (S3_INIT_WINSOCK);
 ...
 *        was issued.
 **/
alias S3ResponseCompleteCallback = void function(S3Status status,
 ...
 *         S3StatusAbortedByCallback.
 **/
alias S3ListServiceCallback = S3Status function(const char *ownerId, 
                                         const char *ownerDisplayName,
                                         const char *bucketName,
 ...
 *         S3StatusAbortedByCallback.
 **/
alias S3ListBucketCallback = S3Status function(int isTruncated,
 ...
 **/
alias S3PutObjectDataCallback = int function(int bufferSize, char *buffer,
                                      void *callbackData);
 ...
 *         S3StatusAbortedByCallback.
 **/
alias S3GetObjectDataCallback = S3Status function(int bufferSize, const char *buffer,
                                           void *callbackData);
